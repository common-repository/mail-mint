...
class Constants {
	...
	public static function get_exsiting_fields_array(): array {
		$exsiting_fields = array(
			...
			array(
				'label' => __( 'Phone Number', 'mrm' ),
				'type'  => 'tel',
				'value' => 'phone_number',
			),
			array(
				'label' => __( 'Date of Birth', 'mrm' ),
				'type'  => 'date',
				'value' => 'date_of_birth',
			),
			array(
				'label' => __( 'Address Line 1', 'mrm' ),
				'type'  => 'text',
				'value' => 'address_line_1',
			),
			array(
				'label' => __( 'Address Line 2', 'mrm' ),
				'type'  => 'text',
			...
			array(
				'label' => __( 'Timezone', 'mrm' ),
				'type'  => 'text',
				'value' => 'timezone',
			),
			array(
				'label' => __( 'Company', 'mrm' ),
				'type'  => 'text',
				'value' => 'company',
			),
			array(
				'label' => __( 'Designation', 'mrm' ),
				'type'  => 'text',
				'value' => 'designation',
			),
		);
